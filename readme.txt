...
Contributors: wpecommerce, RyanStonebraker
...
Accept PayPal subscription or recurring donation payment from your WordPress site.
...
This fork of the original plugin enhances the one time donation ability and adds the same options as for the monthly payments.
