		...
		<div id="tabs" class="dntplgn_form_wrapper">
			...
			<div id="tabs-2">
				...
				<form class="dntplgn_donate_once" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
					...
					<input type="hidden" name="src" value="1">
					<!-- Donate Amount -->
					<input id="single_first_button" type="radio" name="amount" checked="checked" value="<?php echo $dntplgn_atts['recurring_amt1']; ?>" />
					<label for="single_first_button"> <?php echo $currency_symbol; ?><?php echo $dntplgn_atts['recurring_amt1']; ?></label>
					<input id="single_second_button" type="radio" name="amount" value="<?php echo $dntplgn_atts['recurring_amt2']; ?>" />
					<label for="single_second_button"> <?php echo $currency_symbol; ?><?php echo $dntplgn_atts['recurring_amt2']; ?></label>
					<input id="single_third_button" type="radio" name="amount" value="<?php echo $dntplgn_atts['recurring_amt3']; ?>" />
					<label for="single_third_button"> <?php echo $currency_symbol; ?><?php echo $dntplgn_atts['recurring_amt3']; ?></label>
					<input id="single_fourth_button" type="radio" name="amount" value="other" />
					<label for="single_fourth_button"> <?php _e( 'Other', 'donateplugin' ); ?></label></br>
					<input class="dntplgn_once_other_sum" type="text" name="dntplgn_once_other_sum" placeholder="Enter Amount" />
					<!-- End Donate Amount -->
					<input type="hidden" name="currency_code" value="<?php echo $currency_code; ?>">
					<input type="hidden" name="return" value="<?php echo $return_url; ?>">
					<input type="hidden" name="bn" value="TipsandTricks_SP">
